...
TiledのdisplayShelfをshelfにしてincludeで取得するのやっといて
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
2月16日
Gemini Assitみたいなの使い物にならなかった、エラー探す分にはコパイロットよりはましなんだろうけど
部分的に聞いてそれを自分で調整するのがいい、結局信じれるのは自分だけ。

Object.js作ったけど、意味わからんくなったから、また今度する。
デコレーションモード消すか、なんか毎回この品質を置こうって決めるのめんどくさすぎるし、
このゲームにそこまで重要ではない。UIもすっきり

呪術回線過大評価されてるよなって思ってけど、普通に自分の理解能力がないだけだった
ちゃんと見たら面白い。
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
2月17日
NPCのロジックを作る。店にいる時のみ

プレイヤーが店に入ると、初期位置(商品の棚の前)に固定でいる。NPCが買うかどうか判定し、買わないなら他の商品見るか、
店を出るかでもう一度判定、他のを見るなら、NPCがいない商品のある棚からランダムで選び、そこに行く、それの繰り返し、
全部見ても買わないなら強制的に帰る。初期は棚６個で、とりあえず実装。
客の総量は口コミで決まり、減ったら入ってくる感じで、

中途半端に頭がいいと、勝手に未来のこと考えて、勝手に絶望して、勝手に悲しくなる。
自己完結の逆？バージョン

NPCのやつ、moveTo使ったら斜めに進むからちょっと挙動が変。
でもやろうとしてることはできてる。

棚をShopで開いたらボタンクリックできない、経験則、手ごわいエラーの予感→明日修正する。
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
2月18日
Managerで現役なの、MenuとDialogくらいなの面白い。

早寝早起きしなくなって一日が終わるのが早い
NPCは商品のある棚にしか来なくなりました。商品置いたら湧きます(??)。

NPCが商品かったらお金が入るようにする。そして強制的に帰る。

すごい人からしたらこれはおままごとぐらいなんだろうなぁ

明日は加工のロジックを組む
途中まで進めた。レシピのjsonデータをMachineContentかMachineManagerのどちらで取得するか悩んでる途中で終了
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
2月19日
加工の品質判定は、serverでやるんだ。リセットしても結果は同じ
→飽きたから後でやる。

赤い家に
事務デスクを作る→勉強か事務作業(NPCの賃金きめて素材を集めに行かせる事務)の選択を強いる
DeskContentの構成はかなり美しい。

BaseSceneとUISceneの長さに笑った
WorkContetnの方UIぐちゃぐちゃだから、ご飯の後直す
なんかコミットできない

二段階コミットになった最悪！
新しいNPCを雇う画面を作った。ゲームの選択画面みたいなやつ

大好きな曲ほど、歌詞をちゃんと知らないことが多い。
不思議なことに、知ったら良さが半減する。聞こえる言葉を都合よく解釈するからだろうか？
↑くそどうでもいい
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
2月20日
本当の意味で優しい人っていない気がする。優しいのは、それがどうでもいいからであって、
自分に関係あることに対して同じように思う人はいない。いるとしたら人の形をした化け物であり、
その優しさは見返りを求めてるもので、取引そのもの。めんどうがくさい

貿易も事務的な画面にするか、集会所みたいなのを作って、交流みたいな形で貿易を交渉する形にするか
悩み中(両方作るか！どちらにもよさはある、一回作ってみる)
→やっぱり両立の形で行く。最初は交流の感じで、2回目からは簡易取引画面で省略可能になる感じ

3月からはチュートリアル作り始めるぐらいじゃないと間に合わない。遅くとも来年の夏休み前までに完成

API.jsのセーブなどの処理を引っ越しさせる→させた

簡易取引画面は、集会所の簡易マップ上に、npcの動きと連動させる→完了、赤いやつが連動する。
クリックしたらその人との交易画面を開くのは後でやる。

素材はこれ使うPixelart Village Top-Down RPG Asset Pack v2予定
〇達が真ん中に来るようになった。マップ自体がでかすぎたらしい、画像は依然として表示できていないので朝やろう

集中力が持たない。おやすみなさい(0:51);
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
2月21日
取引画面と
口コミ、統計、ランキングも反映されるようにしましょうか。ランキングはどうやるんだろ
↑これらを今日やる。全部できたら大したもんだよ
↑時間的に無理そう(16:42)

簡易取引画面で人がやっと動くようになった、感動する、挫折しかけた。

汚い部屋はその人にとって最適化された空間かもしれないけど、汚いコードはただの汚ねぇコード
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
2月22日
交易の箱を作る。自分が売る商品をセットする時と、昨日注文した商品が届く箱。

注文したらお金減って、交易の箱に行くようにした。交易で注文が届くのは毎朝にする予定。

交易ボックスを作った。インベントリの最大数を減らした25→20

paypal使って買いたいけど、カードもないしゆうちょしか口座ないから詰んでる

沢山素材買った、思わず心の中で円やすぅぅ！！！って叫んだ。

なんとかなった。16*16は小さい・・？。まぁいいや見せ方次第でどうとでもなるね

まずチュートリアルじゃなくて、デモモードを作るべきなんだよな。
private_assetsに入れたけど。大丈夫だよね。逮捕されないよね
*/